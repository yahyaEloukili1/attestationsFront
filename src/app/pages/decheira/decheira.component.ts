...
export class DecheiraComponent implements AfterViewInit, OnDestroy {
  ...
  // ✅ commune polygon latlngs (for filtering points inside)
  ...
  ngAfterViewInit(): void {
    ...
    this.mapService.getCommunes().subscribe((data: FeatureCollection) => {
      ...
      // ✅ extract polygon latlngs from leaflet layer
      ...
      // ✅ Load thematic layers (hidden by default)
