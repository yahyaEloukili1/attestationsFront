...
@Component({
  selector: 'app-province-laayoune2',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './province-laayoune2.component.html',
  styleUrl: './province-laayoune2.component.scss'
})
export class ProvinceLaayoune2Component implements AfterViewInit, OnDestroy {
